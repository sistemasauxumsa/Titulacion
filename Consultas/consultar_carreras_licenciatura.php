...
function consultarCarrerasLicenciatura($id_alumno) {
    try {
        $mysqli = getDatabaseConnection();
        
        $carreras = [];
        
        // Buscar en egresados5 (licenciatura - nivel 5) donde certrec=1 Y certent=1
        $sql_egresados = "SELECT idcarr FROM egresados5 WHERE idal = ? AND certrec = 1 AND certent = 1";
        ...
        error_log("Error consultando carreras de licenciatura: " . $e->getMessage());
        return [];
    }
}
?>
